...
class Manager {
    ...
    setFilesManager() {
        ...
        const generators = this.allLocalDataSources.map(dataSource => {
            ...
            const generator = new Generator(this.currConfig.surrounding, (_a = config) === null || _a === void 0 ? void 0 : _a.outDir);
        ...
        this.fileManager = new generate_1.FilesManager(new FileStructuresClazz(generators, this.currConfig.usingMultipleOrigins, this.currConfig.surrounding, this.currConfig.outDir, this.currConfig.templateType), this.currConfig.outDir);
